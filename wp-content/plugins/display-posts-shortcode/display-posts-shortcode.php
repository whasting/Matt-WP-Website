	...
	while ( $listing->have_posts() ): $listing->the_post(); global $post;
		...
		if ( !$skip ) {
			...
			if ( $include_title && $include_link ) {
				...
				$title = '<a class="post-image" href="' . apply_filters( 'the_permalink', get_permalink() ) . '">' . get_the_post_thumbnail() . '<div class="img-description-' . $idx++ . '"><p class="img-description-text">' . get_the_title() . '</p></div></a>';
